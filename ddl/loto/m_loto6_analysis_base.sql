-- Table: public.m_loto6_analysis_base

-- DROP TABLE public.m_loto6_analysis_base;

CREATE TABLE public.m_loto6_analysis_base
(
    ...
    CONSTRAINT m_loto6_analysis_base_pkey PRIMARY KEY (turn)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE public.m_loto6_analysis_base
    OWNER to postgres;