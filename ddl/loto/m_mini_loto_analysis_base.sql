-- Table: public.m_mini_loto_analysis_base

-- DROP TABLE public.m_mini_loto_analysis_base;

CREATE TABLE public.m_mini_loto_analysis_base
(
    ...
    CONSTRAINT m_mini_loto_analysis_base_pkey PRIMARY KEY (turn)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE public.m_mini_loto_analysis_base
    OWNER to postgres;