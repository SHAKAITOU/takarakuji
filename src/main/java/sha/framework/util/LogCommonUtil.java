...
public class LogCommonUtil {
	...
	private void writeLog(Level level, String title, String msg, Object obj) {
		...
		if(level.equals(Level.TRACE)) {
			log.trace("【トレース】【"+title+"】"+sb.toString());
		}else if(level.equals(Level.DEBUG)) {
			log.debug("【ディバッグ】【"+title+"】"+sb.toString());
		}else if(level.equals(Level.INFO)) {
			log.info("【一般】【"+title+"】"+sb.toString());
		}
		else if(level.equals(Level.NOTIC)) {
			log.info("【注意】【"+title+"】"+sb.toString());
		}else if(level.equals(Level.WARN)) {
			log.warn("【警告】【"+title+"】"+sb.toString());
		}else if(level.equals(Level.ERROR)) {
			log.error("【エラー】【"+title+"】"+sb.toString());
		}else{
			log.error("【致命エラー】【"+title+"】"+sb.toString());
		}
	}
	...
	private void writeLog(Level level, String title, String msg, Throwable t) {
		...
		sb.append(msg);
		if(level.equals(Level.TRACE)) {
			log.trace("【トレース】【"+title+"】"+sb.toString(), t);
		}else if(level.equals(Level.DEBUG)) {
			log.debug("【ディバッグ】【"+title+"】"+sb.toString(), t);
		}else if(level.equals(Level.INFO)) {
			log.info("【一般】【"+title+"】"+sb.toString(), t);
		}
		else if(level.equals(Level.NOTIC)) {
			log.info("【注意】【"+title+"】"+sb.toString(), t);
		}else if(level.equals(Level.WARN)) {
			log.warn("【警告】【"+title+"】"+sb.toString(), t);
		}else if(level.equals(Level.ERROR)) {
			log.error("【エラー】【"+title+"】"+sb.toString(), t);
		}else{
			log.error("【致命エラー】【"+title+"】"+sb.toString(), t);
		}
	}
