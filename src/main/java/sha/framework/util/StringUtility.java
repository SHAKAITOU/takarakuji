...
public class StringUtility {
    ...
    public static Number parseNumber(String text, NumberClass numberClass) {
        ...
        try  {  
            ...
            log.error("failed to parse text to number.", e);
            return null;  
        } 
    }
    ...
    public static String formatNumber(double value, int scale, RoundMode roundMode, Locale locale) {
        ...
        BigDecimal scaledBigDecimal = bigDecimal.setScale(scale, roundMode.getMode());
        NumberFormat numberFormat = NumberFormat.getNumberInstance(
                Optional.ofNullable(locale)
                        .orElse(Locale.getDefault()));
    ...
    public static String formatCurrency(double value, RoundMode roundMode, Locale locale) {
        ...
        BigDecimal resultBigDecimal = bigDecimal.setScale(
                DEFAULT_CURRENCY_SCALE, roundMode.getMode());
        NumberFormat numberFormat = NumberFormat.getCurrencyInstance(
                Optional.ofNullable(locale)
                        .orElse(Locale.getDefault()));
    ...
    public static String formatPercent(double value, 
            int scale, RoundMode roundMode, Locale locale) {
        BigDecimal bigDecimal = new BigDecimal(String.valueOf(value));
        BigDecimal resultBigDecimal = bigDecimal.setScale(scale, roundMode.getMode());
