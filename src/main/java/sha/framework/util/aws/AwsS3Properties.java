...
public class AwsS3Properties {
    ...
    /**
     * the amount of time (in milliseconds) to allow the client 
     * to complete the execution of an API call. 
     */
    ...
    /**
     * the maximum amount of time that an idle connection may sit in the connection pool 
     * and still be eligible for reuse.
     */
    ...
    /**
     * the amount of time to wait (in milliseconds) for the request 
