 ...
 */
@Controller
@RequestMapping("/batch/loto6AnalysisP2CreateFile")
public class Loto6AnalysisP2CreateFileController extends ScreenBaseController{
	...
	@Autowired
	private Loto6AnalysisP2Service service;	
