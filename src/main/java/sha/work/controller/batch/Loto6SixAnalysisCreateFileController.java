...
import sha.work.service.batch.Loto6SixAnalysisDataCreateService;
 ...
 */
@Controller
@RequestMapping("/batch/loto6SixAnalysisCreateFile")
public class Loto6SixAnalysisCreateFileController extends ScreenBaseController{
	...
	@Autowired
	private Loto6SixAnalysisDataCreateService service;	
