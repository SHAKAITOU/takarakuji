 ...
 */
@Controller
@RequestMapping("/batch/loto7AnalysisP2CreateFile")
public class Loto7AnalysisP2CreateFileController extends ScreenBaseController{
	...
	@Autowired
	private Loto7AnalysisP2Service service;	
