 ...
 */
@Controller
@RequestMapping("/batch/miniLotoAnalysisP1CreateFile")
public class MiniLotoAnalysisP1CreateFileController extends ScreenBaseController{
	...
	@Autowired
	private MiniLotoAnalysisP1Service service;	
