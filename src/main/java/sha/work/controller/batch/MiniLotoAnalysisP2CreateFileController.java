 ...
 */
@Controller
@RequestMapping("/batch/miniLotoAnalysisP2CreateFile")
public class MiniLotoAnalysisP2CreateFileController extends ScreenBaseController{
	...
	@Autowired
	private MiniLotoAnalysisP2Service service;	
	...
	public ModelAndView exapmle(@RequestParam Map<String,String> allRequestParams, Locale loc, 
		...
		try {
			...
			file.createNewFile();
			objectMapper.writeValue(file, service.summary());
		} catch (IOException e) {
