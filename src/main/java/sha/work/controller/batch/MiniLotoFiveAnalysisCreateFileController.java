...
import sha.work.service.batch.MiniLotoFiveAnalysisDataCreateService;
 ...
 */
@Controller
@RequestMapping("/batch/miniLotoFiveAnalysisCreateFile")
public class MiniLotoFiveAnalysisCreateFileController extends ScreenBaseController{
	...
	@Autowired
	private MiniLotoFiveAnalysisDataCreateService service;	
